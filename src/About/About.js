                ...
                <div className="content-left">
                    ...
                    <div>
                        <div className="skill-wrapper">
                            <div style={{width: '95%', backgroundColor: '#40407a', textIndent: '1em', padding: '8px', borderRadius: '10px'}}>React</div>
                        </div>
                        <div className="skill-wrapper">
                            <div style={{width: '90%', backgroundColor: '#40407a', textIndent: '1em', padding: '8px', borderRadius: '10px'}}>React Native</div>
                        </div>
                        <div className="skill-wrapper">
                            <div style={{width: '65%', backgroundColor: '#40407a', textIndent: '1em', padding: '8px', borderRadius: '10px'}}>Angular</div>
                        </div>
                        <div className="skill-wrapper">
                            <div style={{width: '93%', backgroundColor: '#40407a', textIndent: '1em', padding: '8px', borderRadius: '10px'}}>NodeJS</div>
                        </div>
                        <div className="skill-wrapper">
                            <div style={{width: '98%', backgroundColor: '#40407a', textIndent: '1em', padding: '8px', borderRadius: '10px'}}>HTML/CSS</div>
                        </div>
                        <div className="skill-wrapper">
                            <div style={{width: '80%', backgroundColor: '#40407a', textIndent: '1em', padding: '8px', borderRadius: '10px'}}>UX Design</div>
                        </div>
                        <div className="skill-wrapper">
                            <div style={{width: '80%', backgroundColor: '#40407a', textIndent: '1em', padding: '8px', borderRadius: '10px'}}>Databases</div>
                        </div>
                    </div>
                </div>
